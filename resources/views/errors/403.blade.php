...
<body>
	...
	<div class="wrapper">
		<nav class="navbar navbar-expand-lg navbar-light bg-white rounded fixed-top rounded-0 shadow-sm">
			<div class="container-fluid">
				<a class="navbar-brand" href="#">
					<img style="max-height: 56px;" src="{{config('app.url')}}assets/images/logo-img.pn"  alt="" />
				</a>
		...
		<div class="mt-5 error-404 d-flex align-items-center justify-content-center">
			<div class="container">
				<div class="card">
					<div class="row g-0">
						<div class="col-xl-5">
							<div class="card-body p-4">
								...
								<h2 class="font-weight-bold display-4">You do not  have persmission to this section</h2>
